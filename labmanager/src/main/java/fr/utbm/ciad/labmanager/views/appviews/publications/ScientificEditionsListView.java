 ...
 * @since 4.0
 */
@Route(value = "editions", layout = MainLayout.class)
@RolesAllowed({UserRole.RESPONSIBLE_GRANT, UserRole.ADMIN_GRANT})
public class ScientificEditionsListView extends StandardScientificEditionListView implements HasDynamicTitle {
    ...
    public String getPageTitle() {
        return getTranslation("views.edition.list"); //$NON-NLS-1$
    }
