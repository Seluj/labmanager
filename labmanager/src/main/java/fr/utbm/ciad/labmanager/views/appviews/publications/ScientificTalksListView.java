...
import fr.utbm.ciad.labmanager.views.components.publications.views.StandardScientificTalkListView;
 ...
 * @since 4.0
 */
@Route(value = "talks", layout = MainLayout.class)
@RolesAllowed({UserRole.RESPONSIBLE_GRANT, UserRole.ADMIN_GRANT})
public class ScientificTalksListView extends StandardScientificTalkListView implements HasDynamicTitle {

    private static final long serialVersionUID = -3520236981121840040L;
     ...
     */
    public ScientificTalksListView(
    ...
    public String getPageTitle() {
        return getTranslation("views.talks.list"); //$NON-NLS-1$
    }
