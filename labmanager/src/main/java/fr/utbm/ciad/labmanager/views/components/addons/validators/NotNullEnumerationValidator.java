...
/**
 * A validator that matches an enumeration that is not {@code null}.
 *
 * @param <T> the type of enumeration for the values
 ...
 * @since 4.0
 */
public class NotNullEnumerationValidator<T extends Enum<T>> extends AbstractValidator<T> {

    private static final long serialVersionUID = -1446624948907082847L;
    ...
    public String toString() {
        return "NotNullEnumerationValidator"; //$NON-NLS-1$
    }
